...
# res_file_to_save
res_file_bm25 = get_trec_res(bm25,topics2)
res_file_bm25.to_csv('res.bm25.50',sep='\t',index=False,header=False,encoding='utf-8')
print("now you can stop")

# res_file_duot5 = get_trec_res(duo_pipeline,topics2)
#
# # print(res_file_duot5.head(5))
#
# res_file_duot5.to_csv('res.ANCE.50.duot5.50',sep='\t',index=False,header=False,encoding='utf-8')
